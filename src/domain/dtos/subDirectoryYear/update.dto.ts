...
export class UpdateSubDirectoryYearDto {
    constructor(
    ...
    static async create(req: Request): Promise<[FieldQuery[]?, UpdateSubDirectoryYearDto?]> {
        ...
        try {
            ...
            return [undefined, new UpdateSubDirectoryYearDto(+id, name, state)];
        }
    }
}
